          ...
          <form class="product-creat-form" action="productCreate.php" method="post" enctype="multipart/form-data">
            <div class="row p-1 justify-content-center">
              <div class="col-12 mb-3">
                <div class="row">
                  ...
                  <div class="col-3">
                    ...
                    <input list="brandList" name="brand" placeholder="請選擇品牌"></label>
                ...
                <div class="row">
                  ...
                  <div class="d-flex col-12 row py-3 mx-2 my-1 type-config shadow-sm typeList" data-type="1">
                    <select class="col-1 mr-2 bg-transparent typeListSelect" name="type[]" id="">
                      <option value="0">規格種類</option>
                    </select>
                    <input class="col-1 bg-transparent typeInput" type="text" placeholder="ex:粉紅色" name="typeValue1[]">
                  ...
                  <div class="d-flex col-12 row py-3 mx-2 my-1 type-config shadow-sm typeList" data-type="2">
                    <select class="col-1 mr-2 bg-transparent typeListSelect" name="type[]" id="typeList">
                      <option value="0">規格種類</option>
                    </select>
                    <input class="col-1 bg-transparent typeInput" type="text" placeholder="ex: XL" name="typeValue2[]">
                    <a class="addBtn btn btn-success text-white p-0 my-0 mx-1 typeListAdd" id="">+</a>
                  </div>
                </div>
                <hr>
              ...
              <div class="col-12">
                ...
                <textarea name="intro" id="" cols="30" rows="10" class="scrollbar"></textarea>
              </div>
